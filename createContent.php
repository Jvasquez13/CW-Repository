  ...
  <div class="sidebar">
    ...
    <div class="sidebar-menu">
      <ul>
        ...
        <li>
          <a href="createContent.php" class="active"><span class="las la-book-reader"></span>
  ...
  <div class="main-content">
    ...
    <main>
      ...
      <section class="container_admin">
        ...
        <h1>Content Registration</h1>
        <form action="agregarContent.php" method="POST">
          <div class="field">
            <input type="text" name="title" id="title" required>
            <span></span>
            <label>Title Resource</label>
          </div>
          <div class="field">
            <input type="text" name="type" id="type" required>
            <span></span>
            <label>Type of Resources</label>
          </div>
          <div class="field">
